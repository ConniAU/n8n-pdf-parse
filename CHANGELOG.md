...
## [1.6.2] - 2026-01-14
- **updated readme to adapt the recent n8n base image update, add apk when build the image

## [1.6.1] - 2025-09-16

### 🔧 **Maintenance Update**
- **Version Bump**: Updated package version for consistency
- **Dependencies**: All dependencies remain stable and compatible
- **No Breaking Changes**: Fully backward compatible with 1.6.0
